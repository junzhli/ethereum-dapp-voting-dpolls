...
* ```REACT_APP_NETWORK_ID``` - Restrict user to run only on specific Network ID (1: Mainnet, 3: Ropsten..., etc) where the Voting Core deployed *(optional - defaults to all network)*
