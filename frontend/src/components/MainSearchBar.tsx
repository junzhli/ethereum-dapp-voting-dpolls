        ...
        return(
            <div>
                ...
                <Ref innerRef={this.searchBar}>
                    <Input disabled={!this.props.searchBarEnabled} onChange={this.userInputOnChange} fluid={true} size="large" icon={(this.props.userSearchKeywords === null) ? "search" : <Icon name="times" link={true} onClick={this.clearSearchHandler} />} placeholder={this.props.searchBarEnabled ? "Search polls" : "Search polls (still loading...)"} loading={!this.props.searchBarEnabled} />
                </Ref>
            </div>
        );
    }
